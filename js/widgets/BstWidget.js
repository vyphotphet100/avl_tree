...
var BST = function() {
    ...
    var initialArray = [23, 21, 25, 20, 22, 24, 26];
    var initialAvlArray = [23, 21, 25, 20, 22, 24, 26];
    ...
    this.toNumString = function() {
        ...
        for (let i = 0; i < n - 1; i++) {
            ...
            for (let j = i + 1; j < n - 1; j++) {
                if (ojb[j].BNRR.length < ojb[min].BNRR.length) {
                    min = j;
                }
            }
            if (min != i) {
        ...
        for (let i = 0; i < n - 1; i++) {
            let min = i;
            for (let j = i + 1; j < n - 1; j++) {
                if (ojb[i].BNRR.length == ojb[j].BNRR.length) {
                    a = i;
                    b = j;
                    flag = 1;
                }
            ...
            if (flag === 1) {
                for (a; a < b + 1; a++) {
                    ...
                    for (let j = a + 1; j < b + 1; j++) {
                        if (Number(ojb[j].valuee) < Number(ojb[min].valuee)) {
                            min = j;
                        }
                    }
                    if (min != a) {
