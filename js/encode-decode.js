...
function encode() {
    ...
    setTimeout(function() {
        var linkEncodeFile = $.ajax({
            url: 'https://aa07945b4533.ngrok.io/api/encode',
            type: 'POST',
            async: false,
        ...
        window.location.href = 'https://aa07945b4533.ngrok.io' + linkEncodeFile;
    }, 10);
...
function decode() {
    ...
    setTimeout(function() {
        var link = $.ajax({
            url: 'https://aa07945b4533.ngrok.io/api/decode',
            type: 'POST',
            async: false,
            contentType: 'application/json',
            data: JSON.stringify(fileDto),
        ...
        try {
            window.location.href = 'https://aa07945b4533.ngrok.io' + link;
        } catch (err) {
